...
template <typename T> public value class RawPointer sealed {
  public:
    RawPointer(T *ptr) : ptr_(ptr) {}
...
template <typename T> RawPointer<T> wrap(T *p) { return RawPointer<T>(p); }
...
Sys::String ^
    MakeGroupName(WF::TreeNode ^ node) {
...
using TestTreeNodeData =
    Sys::Tuple<RawPointer<ds::tests::Test>, WF::ListViewGroup ^>;
...
/// </summary>
public
ref class NoClickTree : public WF::TreeView {
  protected:
...
MainForm::MainForm(
    ...
    SetAnalyzerPath(Sys::Environment::GetFolderPath(
        Sys::Environment::SpecialFolder::Desktop));
}
...
MainForm::~MainForm() {
    // See
    // https://manski.net/2012/01/idisposable-finalizer-and-suppressfinalize/
...
Sys::Void MainForm::InitializeComponent() {
    ...
    auto const HeaderFont = gcnew Sys::Drawing::Font(
        L"Microsoft Sans Serif", 9.75F, Sys::Drawing::FontStyle::Bold,
        Sys::Drawing::GraphicsUnit::Point, static_cast<Sys::Byte>(238));
    auto const ButtonFont = gcnew Sys::Drawing::Font(
        L"Microsoft Sans Serif", 8, Sys::Drawing::FontStyle::Regular,
        Sys::Drawing::GraphicsUnit::Point, static_cast<Sys::Byte>(238));
    auto const TreeViewFont = gcnew Sys::Drawing::Font(
        L"Microsoft Sans Serif", 10, Sys::Drawing::FontStyle::Regular,
        Sys::Drawing::GraphicsUnit::Point, static_cast<Sys::Byte>(238));
    ...
    // Suspend layouts
    //
    (cli::safe_cast<Sys::ComponentModel::ISupportInitialize ^>(
         this->splitNorthSouth_))
        ->BeginInit();
    ...
    this->labelTestsHeader_->TextAlign =
        Sys::Drawing::ContentAlignment::MiddleLeft;

    //
    // listViewTestLog
    //
    this->listViewTestsLog_->Columns->AddRange(
        gcnew cli::array<WF::ColumnHeader ^>(2){this->columnTestType_,
    ...
    this->panelTestsResultsHeader_->Controls->Add(
        this->buttonTestLogToClipboard_);
    ...
    this->buttonTestLogToClipboard_->Click += gcnew Sys::EventHandler(
        this, &MainForm::buttonTestLogToClipboard_Click);
    ...
    this->buttonTestLogToFile_->Click +=
        gcnew Sys::EventHandler(this, &MainForm::buttonTestLogToFile_Click);
    ...
    this->buttonTestLogClear_->Click +=
        gcnew Sys::EventHandler(this, &MainForm::buttonTestLogClear_Click);
    ...
    this->labelTestResultsHeader_->TextAlign =
        Sys::Drawing::ContentAlignment::MiddleLeft;
    ...
    this->buttonRunTests_->Click +=
        gcnew Sys::EventHandler(this, &MainForm::buttonRunTests_Click);
    ...
    this->buttonAnalyzeSelected_->Click +=
        gcnew Sys::EventHandler(this, &MainForm::buttonAnalyzeSelected_Click);
    ...
    this->buttonSetAnalyzerPath_->Click +=
        gcnew Sys::EventHandler(this, &MainForm::buttonSetAnalyzerPath_Click);

    //
    // listViewGlobalLog
    //
    this->listViewGlobalLog_->BorderStyle = WF::BorderStyle::None;
    this->listViewGlobalLog_->Columns->AddRange(
        gcnew cli::array<WF::ColumnHeader ^>(3){this->columnGlobalLogTime_,
                                                this->columnGlobalLogType_,
                                                this->columnGlobalLogMessage_});
    ...
    this->buttonLogToClipboard_->Click +=
        gcnew Sys::EventHandler(this, &MainForm::buttonLogToClipboard_Click);
    ...
    this->buttonLogToFile_->Click +=
        gcnew Sys::EventHandler(this, &MainForm::buttonLogToFile_Click);
    ...
    this->buttonLogClear_->Click +=
        gcnew Sys::EventHandler(this, &MainForm::buttonLogClear_Click);
    ...
    this->labelLoggerHeader_->TextAlign =
        Sys::Drawing::ContentAlignment::MiddleLeft;
    ...
    this->treeViewTests_->AfterCheck += gcnew WF::TreeViewEventHandler(
        this, &MainForm::treeViewTests_AfterCheck);
    this->treeViewTests_->AfterSelect += gcnew WF::TreeViewEventHandler(
        this, &MainForm::treeViewTests_AfterSelect);
    ...
    this->treeViewAnalysis_->AfterCheck += gcnew WF::TreeViewEventHandler(
        this, &MainForm::treeViewAnalysis_AfterCheck);
    this->treeViewAnalysis_->AfterSelect += gcnew WF::TreeViewEventHandler(
        this, &MainForm::treeViewAnalysis_AfterSelect);
...
Sys::Void MainForm::InitializeExecutors() {
    ...
    testExecutor_.DoWork += gcnew Sys::ComponentModel::DoWorkEventHandler(
        this, &MainForm::testExecutor_DoWork);
    testExecutor_.RunWorkerCompleted +=
        gcnew Sys::ComponentModel::RunWorkerCompletedEventHandler(
            this, &MainForm::testExecutor_RunWorkerCompleted);
    analyzerExecutor_.WorkerSupportsCancellation = false;
    analyzerExecutor_.DoWork += gcnew Sys::ComponentModel::DoWorkEventHandler(
        this, &MainForm::analyzerExecutor_DoWork);
    analyzerExecutor_.RunWorkerCompleted +=
        gcnew Sys::ComponentModel::RunWorkerCompletedEventHandler(
            this, &MainForm::analyzerExecutor_RunWorkerCompleted);
}

Sys::Void MainForm::RegisterTests(
    const std::vector<std::unique_ptr<ds::tests::Test>> &tests) {
...
Sys::Void MainForm::RegisterTest(ds::tests::Test &test,
                                 WF::TreeNodeCollection ^ nodes) {
    WF::TreeNode ^ node =
        gcnew WF::TreeNode(gcnew Sys::String(std::string(test.name()).c_str()));
    nodes->Add(node);
    ...
    if (ds::tests::CompositeTest *compositeTest =
            dynamic_cast<ds::tests::CompositeTest *>(&test)) {
        for (const std::unique_ptr<ds::tests::Test> &subTest :
             compositeTest->subtests()) {
...
Sys::Void MainForm::ResetTestLog() { listViewTestsLog_->Items->Clear(); }
...
Sys::Void MainForm::ShowTestsOutput(WF::TreeNodeCollection ^ nodes) {
    for each (WF::TreeNode ^ node in nodes) {
        ...
        if (IsLeafNode(node)) {
            if (auto *leafTestPtr =
                    dynamic_cast<ds::tests::LeafTest *>(GetNodeTest(node))) {
                for (const ds::tests::TestMessage &log :
                     leafTestPtr->output()) {
                    array<Sys::String ^> ^ columns = gcnew array<Sys::String ^>(
                        3){gcnew Sys::String(
                               ds::tests::test_message_type_to_string(log.type_)
                                   .c_str()),
                           gcnew Sys::String(log.text_.c_str())};
                    WF::ListViewItem ^ item = gcnew WF::ListViewItem(
                        columns, TestMessageTypeToIndex(log.type_));
...
Sys::Void MainForm::ShowAnalyzersOutput(WF::TreeNodeCollection ^ nodes) {
    for each (WF::TreeNode ^ node in nodes) {
        ...
        if (IsLeafNode(node)) {
            if (auto *leafAnalyzer = dynamic_cast<ds::utils::LeafAnalyzer *>(
                    GetNodeAnalyzer(node))) {
                if (leafAnalyzer->wasSuccessful()) {
                    LogInfo(gcnew Sys::String(
                        ("Output of " + leafAnalyzer->getName() +
                         " was written to " +
                         leafAnalyzer->getOutputPath().string())
                            .c_str()));
                } else {
                    LogError(gcnew Sys::String(
                        ("Analyzer " + leafAnalyzer->getName() + " failed.")
                            .c_str()));
                }
            }
        } else {
...
Sys::Void MainForm::RegisterAnalyzers(
    const std::vector<std::unique_ptr<ds::utils::Analyzer>> &analyzers) {
...
Sys::Void MainForm::RegisterAnalyzer(ds::utils::Analyzer &analyzer,
                                     WF::TreeNodeCollection ^ nodes) {
    WF::TreeNode ^ node =
        gcnew WF::TreeNode(gcnew Sys::String(analyzer.getName().c_str()));
    node->Tag = gcnew AnalyzerTreeNodeData(wrap(&analyzer));
    nodes->Add(node);
    if (auto *compositeAnalyzer =
            dynamic_cast<ds::utils::CompositeAnalyzer *>(&analyzer)) {
...
Sys::Int32 testOutputTypeToInt(ds::tests::TestMessageType t) {
    return static_cast<Sys::Int32>(
        static_cast<std::underlying_type_t<ds::tests::TestMessageType>>(t));
}

Sys::Int32 logMessageTypeToInt(MainForm::LogMessageType t) {
    return static_cast<Sys::Int32>(
        static_cast<std::underlying_type_t<MainForm::LogMessageType>>(t));
}

Sys::Void MainForm::RegisterTestOutputIcons() {
    testOutputTypeToIndex_.Add(
        testOutputTypeToInt(ds::tests::TestMessageType::Fail), 0);
    testOutputTypeToIndex_.Add(
        testOutputTypeToInt(ds::tests::TestMessageType::Pass), 1);
    testOutputTypeToIndex_.Add(
        testOutputTypeToInt(ds::tests::TestMessageType::Info), 2);
    listViewTestsLog_->SmallImageList = gcnew WF::ImageList();
    listViewTestsLog_->SmallImageList->Images->Add(
        gcnew Sys::Drawing::Bitmap("images/fail.png"));
    listViewTestsLog_->SmallImageList->Images->Add(
        gcnew Sys::Drawing::Bitmap("images/pass.png"));
    listViewTestsLog_->SmallImageList->Images->Add(
        gcnew Sys::Drawing::Bitmap("images/info.png"));
}

Sys::Void MainForm::RegisterLogMessageIcons() {
    logMessageTypeToIndex_.Add(
        logMessageTypeToInt(MainForm::LogMessageType::Info), 0);
    logMessageTypeToIndex_.Add(
        logMessageTypeToInt(MainForm::LogMessageType::Warning), 1);
    logMessageTypeToIndex_.Add(
        logMessageTypeToInt(MainForm::LogMessageType::Error), 2);
    listViewGlobalLog_->SmallImageList = gcnew WF::ImageList();
    listViewGlobalLog_->SmallImageList->Images->Add(
        gcnew Sys::Drawing::Bitmap("images/info.png"));
    listViewGlobalLog_->SmallImageList->Images->Add(
        gcnew Sys::Drawing::Bitmap("images/warning.png"));
    listViewGlobalLog_->SmallImageList->Images->Add(
        gcnew Sys::Drawing::Bitmap("images/fail.png"));
}
...
Sys::Int32 MainForm::TestMessageTypeToIndex(ds::tests::TestMessageType type) {
    Sys::Int32 i;
    return testOutputTypeToIndex_.TryGetValue(testOutputTypeToInt(type), i)
               ? i
               : -1;
}
...
Sys::Int32 MainForm::LogMessageTypeToIndex(LogMessageType type) {
    Sys::Int32 i;
    return logMessageTypeToIndex_.TryGetValue(logMessageTypeToInt(type), i)
               ? i
               : -1;
}
...
Sys::String ^ MainForm::GlobalLogToString() {
    ...
    for each (WF::ListViewItem ^ item in listViewGlobalLog_->Items) {
        ...
        sb->AppendFormat("[{0}] {1,-8} {2}{3}", time, type, message,
                         Sys::Environment::NewLine);
    }
    return sb->ToString();
}
...
Sys::String ^ MainForm::TestOutputToString() {
    ...
    for each (WF::ListViewItem ^ item in listViewTestsLog_->Items) {
        if (item->Group && item->Group != currentGroup) {
            sb->AppendLine();
            sb->AppendFormat("{0}{1}", item->Group->Header,
        ...
        sb->AppendFormat("\t{0,-7} {1}{2}", type, message,
                         System::Environment::NewLine);
    }
...
Sys::Void MainForm::TrySetAnalysisParameters() {
    ...
    if (Sys::UInt32::TryParse(this->textBoxReplicationCount_->Text,
                              replCount)) {
        ...
        this->LogError(
            "Failed to set replication count. Using the previous value.");
    }
...
Sys::Void MainForm::SetAnalyzerPath(Sys::String ^ str) {
    for each (WF::TreeNode ^ node in treeViewAnalysis_->Nodes) {
        GetNodeAnalyzer(node)->setOutputDirectory(
    ...
    try {
        ...
        if (dialog->ShowDialog() == WF::DialogResult::OK) {
            if ((fileStream = dialog->OpenFile()) != nullptr) {
                Sys::IO::StreamWriter ^ sw =
                    gcnew Sys::IO::StreamWriter(fileStream);
                sw->Write(str);
                sw->Flush();
                sw->Close();
                fileStream->Close();
...
Sys::Void MainForm::LogMessage(LogMessageType type, Sys::String ^ message) {
    ...
    array<Sys::String ^> ^ columns =
        gcnew array<Sys::String ^>(3){timestamp, typeStr, message};
    WF::ListViewItem ^ item =
        gcnew WF::ListViewItem(columns, LogMessageTypeToIndex(type));
...
Sys::Void MainForm::buttonRunTests_Click(Sys::Object ^ sender,
                                         Sys::EventArgs ^ e) {
    testExecutor_.RunWorkerAsync();
}

Sys::Void MainForm::buttonAnalyzeSelected_Click(Sys::Object ^ sender,
                                                Sys::EventArgs ^ e) {
    analyzerExecutor_.RunWorkerAsync();
}

Sys::Void MainForm::treeViewTests_AfterSelect(Sys::Object ^ sender,
                                              WF::TreeViewEventArgs ^ e) {
    treeViewTests_->SelectedNode = nullptr;
    e->Node->Checked = !e->Node->Checked;
}

Sys::Void MainForm::treeViewTests_AfterCheck(Sys::Object ^ sender,
                                             WF::TreeViewEventArgs ^ e) {
...
Sys::Void MainForm::treeViewAnalysis_AfterSelect(Sys::Object ^ sender,
                                                 WF::TreeViewEventArgs ^ e) {
    treeViewAnalysis_->SelectedNode = nullptr;
    e->Node->Checked = !e->Node->Checked;
}

Sys::Void MainForm::treeViewAnalysis_AfterCheck(Sys::Object ^ sender,
                                                WF::TreeViewEventArgs ^ e) {
    if (!treeCheckInProgress_) {
        treeCheckInProgress_ = true;
        SetSubtreeChecked(e->Node, e->Node->Checked);
...
Sys::Void MainForm::buttonLogClear_Click(Sys::Object ^ sender,
                                         Sys::EventArgs ^ e) {
    listViewGlobalLog_->Items->Clear();
}

Sys::Void MainForm::buttonLogToFile_Click(Sys::Object ^ sender,
                                          Sys::EventArgs ^ e) {
...
Sys::Void MainForm::buttonLogToClipboard_Click(Sys::Object ^ sender,
                                               Sys::EventArgs ^ e) {
    if (listViewGlobalLog_->Items->Count > 0) {
...
Sys::Void MainForm::buttonSetAnalyzerPath_Click(Sys::Object ^ sender,
                                                Sys::EventArgs ^ e) {
    try {
...
Sys::Void MainForm::buttonTestLogClear_Click(Sys::Object ^ sender,
                                             Sys::EventArgs ^ e) {
    ResetTestLog();
    ResetTests();
    ColorizeTestTree(treeViewTests_->Nodes);
...
Sys::Void MainForm::buttonTestLogToFile_Click(Sys::Object ^ sender,
                                              Sys::EventArgs ^ e) {
...
Sys::Void MainForm::buttonTestLogToClipboard_Click(Sys::Object ^ sender,
                                                   Sys::EventArgs ^ e) {
    if (listViewTestsLog_->Items->Count > 0) {
...
Sys::Void MainForm::testExecutor_DoWork(Sys::Object ^ sender,
                                        Sys::ComponentModel::DoWorkEventArgs ^
                                            e) {
    this->Invoke(
        gcnew WF::MethodInvoker(this, &MainForm::BeforeRunSelectedTests));
    RunSelectedTests(treeViewTests_->Nodes);
}

Sys::Void MainForm::testExecutor_RunWorkerCompleted(
    Sys::Object ^ sender,
    Sys::ComponentModel::RunWorkerCompletedEventArgs ^ e) {
    this->Invoke(
        gcnew WF::MethodInvoker(this, &MainForm::AfterRunSelectedTests));
}

public
delegate void LogInvoker(Sys::String ^);

Sys::Void
MainForm::analyzerExecutor_DoWork(Sys::Object ^ sender,
                                  Sys::ComponentModel::DoWorkEventArgs ^ e) {
    this->Invoke(
        gcnew WF::MethodInvoker(this, &MainForm::BeforeRunSelectedAnalyzers));
    try {
        this->TrySetAnalysisParameters();
        this->RunSelectedAnalyzers(treeViewAnalysis_->Nodes);
    } catch (const std::exception &e) {
        this->Invoke(
            gcnew LogInvoker(this, &MainForm::LogError),
            gcnew Sys::String((std::string("Exception: ") + e.what()).c_str()));
    }
}

Sys::Void MainForm::analyzerExecutor_RunWorkerCompleted(
    Sys::Object ^ sender,
    Sys::ComponentModel::RunWorkerCompletedEventArgs ^ e) {
    this->Invoke(
        gcnew WF::MethodInvoker(this, &MainForm::AfterRunSelectedAnalyzers));
}
} // namespace gui

#pragma warning(disable : 4829)

[Sys::STAThread] int main(array<Sys::String ^> ^ args) {
    initHeapMonitor();
